...
Style::FontHorizontalRight => Ok((font_horizontal_right::HEIGHT, font_horizontal_right::SET)),
...
Style::FontJsCapitalCurves => Ok((font_js_capital_curves::HEIGHT, font_js_capital_curves::SET)),
...
Style::FontNancyjUnderlined => Ok((font_nancyj_underlined::HEIGHT, font_nancyj_underlined::SET)),
